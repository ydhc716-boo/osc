/**
 * @file    usbd_desc.c
 * @brief   USB Device Descriptors — SCO Oscilloscope.
 *
...
#define USBD_PID                      0x5740   /* STM32 Virtual ComPort */
#define USBD_LANGID_STRING            1033     /* English US */

#define USBD_MANUFACTURER_STRING      "SCO Project"
#define USBD_PRODUCT_STRING           "SCO USB Oscilloscope"
...
/* ── Descriptor Forward Declarations ────────────────────────────────────── */
...
/* ── Serial Number from Unique Device ID ────────────────────────────────── */
